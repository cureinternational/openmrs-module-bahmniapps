...
describe('surgicalAppointmentService', function () {
    ...
    it('should get the surgical blocks in the given date range with custom representation', function (done) {
        ...
        expect(mockHttp.get.calls.mostRecent().args[1].params).toEqual({ startDatetime : Bahmni.Common.Util.DateUtil.parseLongDateToServerFormat(startDatetime), endDatetime : Bahmni.Common.Util.DateUtil.parseLongDateToServerFormat(endDatetime), includeVoided: false, activeBlocks: true, v: "custom:(id,uuid," +
